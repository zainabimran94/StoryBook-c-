...
namespace StoryBook.Migrations
{
    ...
    [Migration("20241024060026_UpdateuserSelectPref")]
    partial class UpdateuserSelectPref
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StoryBook.Models.UserStoryPref", b =>
                {
                    ...
                    b.Property<Guid?>("UserSelectPreferencesUserSelectPrefId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserSelectPreferencesUserSelectPrefId");
            ...
            modelBuilder.Entity("StoryBook.Models.UserStoryPref", b =>
                {
                    ...
                    b.HasOne("StoryBook.Models.UserSelectPreferences", null)
                        .WithMany()
                        .HasForeignKey("UserSelectPrefId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("StoryBook.Models.UserSelectPreferences", "UserSelectPreferences")
                        .WithMany()
                        .HasForeignKey("UserSelectPreferencesUserSelectPrefId");
